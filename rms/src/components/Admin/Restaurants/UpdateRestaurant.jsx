...
const UpdateRestaurant = () => {
  ...
  const url = `http://localhost:3005/restaurantApi/restaurants/getSingleRestaurant/${id}`;
  useEffect(() => {
    fetchSingleRestaurant(url);
  }, [id]);
  ...
  useEffect(() => {
    if (singleRestaurant)
      setFormData({
        ...
        contactInformation: singleRestaurant["contact"],
  ...
  if (singleRestaurantError || loading) {
    return (
      <div>
        <Loading />
      </div>
      ...
      <>
        <AddRoomContainer>
          ...
          <article className="form-article">
            <form
              action={`http://localhost:3005/restaurantApi/restaurants/updateRestaurant/${id}`}
              method="post"
            ...
            >
              <div class="form-floating mb-3">
                ...
                />
                <label for="floatingInput">{formData.restaurantName}</label>
              </div>
              <div class="form-floating">
                <textarea
                  ...
                  rows={20}
                />
                <label for="floatingArea">{formData.address}</label>
              </div>
              <div class="form-floating mb-3">
                <input
                  type="text"
              ...
              <div style={{ marginTop: "10px" }}>
                <input
                  ...
                  placeholder={`http://localhost:3005/images/${singleRestaurant["image"]}`}
                />
              </div>
