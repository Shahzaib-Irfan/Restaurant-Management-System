    ...
    <>
      <AddRoomContainer>
        ...
        <article className="form-article">
          <form action="http://localhost:3005/tableApi/tables" method="post">
            ...
            <div class="form-floating">
              <select
                ...
                name="restaurantID"
                onChange={handleInputChange}
                value={formData.restaurantID} // Ensure the selected value is set
              >
            ...
            <div class="form-floating mb-3">
              <input
                ...
                onChange={handleInputChange}
              />
              <label for="InputIngredients">Sitting Capacity</label>
            </div>
