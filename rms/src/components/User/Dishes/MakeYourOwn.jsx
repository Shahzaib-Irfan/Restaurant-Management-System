    ...
    try {
      ...
      if (token !== "") {
        response = await axios.post(
          "http://localhost:3005/userDishApi/makeyourowndish",
          {
            method: "POST",
            body: { ...formDataForSubmit, userID: currentUser.id },
          }
        );
      }
    ...
    <>
      <AddRoomContainer>
        ...
        <article className="form-article">
          <form
            action={`http://localhost:3005/userDishApi/makeyourowndish/${currentUser.id}`}
            method="post"
          ...
          >
            ...
            <div style={{ margin: "10px 0px 0px 10px" }}>
              <div style={{ display: "flex", alignItems: "center" }}>
                <label htmlFor="rate">Suggest Your Price</label>
                <input
